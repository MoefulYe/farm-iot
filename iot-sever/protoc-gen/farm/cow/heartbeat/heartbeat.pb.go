...
func (x *HeartBeat) GetLatitude() float64 {
	if x != nil {
		return x.Latitude
	}
	return 0
...
func (x *HeartBeat) GetLongitude() float64 {
	if x != nil {
		return x.Longitude
	}
	return 0
...
func (x *HeartBeat) GetWeight() float64 {
	if x != nil {
		return x.Weight
	}
	return 0
...
func (x *HeartBeat) GetHealth() float64 {
	if x != nil {
		return x.Health
	}
	return 0
...
var file_heartbeat_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x12, 0x66, 0x61, 0x72, 0x6d, 0x2e, 0x63, 0x6f, 0x77, 0x2e, 0x68, 0x65, 0x61, 0x72,
	0x74, 0x62, 0x65, 0x61, 0x74, 0x22, 0xa9, 0x01, 0x0a, 0x09, 0x48, 0x65, 0x61, 0x72, 0x74, 0x42,
	0x65, 0x61, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70,
	...
	0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x1a, 0x0a, 0x08, 0x6c, 0x61, 0x74, 0x69, 0x74,
	...
	0x01, 0x52, 0x06, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x68, 0x65, 0x61,
	0x6c, 0x74, 0x68, 0x18, 0x06, 0x20, 0x01, 0x28, 0x01, 0x52, 0x06, 0x68, 0x65, 0x61, 0x6c, 0x74,
	0x68, 0x42, 0x14, 0x5a, 0x12, 0x66, 0x61, 0x72, 0x6d, 0x2f, 0x63, 0x6f, 0x77, 0x2f, 0x68, 0x65,
...
var file_heartbeat_proto_goTypes = []interface{}{
	(*HeartBeat)(nil), // 0: farm.cow.heartbeat.HeartBeat
}
