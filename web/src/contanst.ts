...
export const CENTER = [(LONGITUDE_LOWWER_BOUNDARY + LONGITUDE_UPPER_BOUNDARY) / 2, (LATITUDE_LOWWER_BOUNDARY + LATITUDE_UPPER_BOUNDARY) / 2]
...
export const BMAP_JS_API = `https://api.map.baidu.com/api?v=3.0&ak=${BMAP_KEY}`
